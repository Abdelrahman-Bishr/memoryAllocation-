...
#include "../memoryAllocation/segment.h"
...
QT_MOC_LITERAL(1, 8, 11), // "deallocated"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 15) // "startingAddress"

    },
    "Segment\0deallocated\0\0startingAddress"
};
...
void Segment::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->deallocated((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Segment::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Segment::deallocated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Segment::deallocated(int _t1)
{
